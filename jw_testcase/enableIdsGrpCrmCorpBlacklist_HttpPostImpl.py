...
class testcase_enableIdsGrpCrmCorpBlacklist_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_enableIdsGrpCrmCorpBlacklist(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"displayData":"","logAbstractInfo":"","logInfoDto":"","mainId":0,"originData":[],"requestCommonDto":{"sessionKey":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","unitUid":"","validReqDtoStatus":""},"submitData":[]}
