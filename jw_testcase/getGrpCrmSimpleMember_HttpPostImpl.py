...
class testcase_getGrpCrmSimpleMember_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_getGrpCrmSimpleMember(self):
            ...
            responsejsonStr={"responseCommonDto":{"errorLevel":"","lans":"","message":"","resultCode":"","sessionKey":"","token":"","tracerId":""},"resultData":{"id":0,"loginCd":"","loginPwd":"","profileNo":"","version":0}}
