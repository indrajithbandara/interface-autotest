...
class testcase_GrpCrmProfileCertificateDelIds_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_GrpCrmProfileCertificateDelIds(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"displayData":"","ids":[],"logAbstractInfo":"","logDiffer":[],"logInfoDto":"","mainId":0,"requestCommonDto":{"sessionKey":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","unitUid":"","validReqDtoStatus":""}}
