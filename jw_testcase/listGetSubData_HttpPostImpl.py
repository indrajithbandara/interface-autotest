...
class testcase_listGetSubData_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_listGetSubData(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"currentPage":0,"displayData":"","logAbstractInfo":"","logDiffer":[],"logInfoDto":"","mainId":0,"orderColumn":{"":""},"pageSize":0,"queryBuilder":{"query":"","subIds":[],"typFlg":""},"requestCommonDto":{"sessionKey":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","unitUid":"","validReqDtoStatus":""}}
