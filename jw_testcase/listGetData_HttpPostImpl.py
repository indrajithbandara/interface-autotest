...
class testcase_listGetData_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_listGetData(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"certificate_idcd":"","certificatetypId":0,"chainUid":"","displayData":"","email":"","fastQuery":"","id":0,"ids":[],"joinDate":"","jointypId":0,"languageId":0,"logAbstractInfo":"","logDiffer":[],"logInfoDto":"","loginCd":"","memberStat":"","memberrankId":0,"membertypId":0,"orderColumn":[],"pageLength":"","pageStart":"","phone":"","primaryFlg":"","profileNo":"","quitDate":"","referorg":"","referrer":"","requestCommonDto":{"sessionKey":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","unitUid":"","validReqDtoStatus":""},"salerId":0,"statusFlg":"","unitUid":"","validedDate":"","validstDate":""}
