...
class testcase_delIdsGrpCrmCorpManageunit_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_delIdsGrpCrmCorpManageunit(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"displayData":"","logAbstractInfo":"","logDiffer":[],"logInfoDto":"","mainId":0,"requestCommonDto":{"sessionKey":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","unitUid":"","validReqDtoStatus":""},"subIds":[]}
