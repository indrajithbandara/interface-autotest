...
class testcase_GrpCrmProfileBlacklistDelIds_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_GrpCrmProfileBlacklistDelIds(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"blackIds":{"":""},"displayData":"","ids":[],"logAbstractInfo":"","logDiffer":[],"logInfoDto":"","mainId":0,"requestCommonDto":{"sessionKey":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","unitUid":"","validReqDtoStatus":""}}
