...
class testcase_queryListByUnitUid_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_queryListByUnitUid(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"chainUid":"","checkgrps2Id":0,"checkgrpsId":0,"checksalersId":0,"displayData":"","employeeId":0,"employeeNm":"","id":0,"logAbstractInfo":"","logDiffer":[],"logInfoDto":"","managerFlg":"","orderColumn":[],"pageLength":"","pageStart":"","requestCommonDto":{"sessionKey":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","unitUid":"","validReqDtoStatus":""},"salerId":0,"salergrp2Id":0,"salergrpId":0,"seq":0,"statusFlg":"","unitUid":""}
            ...
            responsejsonStr={"responseCommonDto":{"errorLevel":"","lans":"","message":"","resultCode":"","sessionKey":"","token":"","tracerId":""},"responseDto":[]}
